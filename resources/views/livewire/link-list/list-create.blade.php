        ...
        <form wire:submit.prevent="store" action="#" method="POST" role="form">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <div class="col-span-2">
                    ...
                    <input wire:model="name" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type the name of the list to create..." required="">
                </div>
            </div>
            <!-- Modal footer -->
