...
<div class="flex justify-end">
  <div class="relative w-36 md:w-96">
    ...
    <input type="text" id="search" class="block w-full pl-10 text-sm text-gray-900 bg-white border border-slate-400 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Buscar...">
  </div>
</div>
        </div>
    </header>
                    ...
                    <div class="grid gap-4 md:grid-cols-3 md:gap-6">
                        ...
                        <article class="bg-white h-200 w-130 flex flex-col shadow-lg rounded overflow-hidden">
                            ...
                            <div class="flex justify-between p-5">
                                <a href="{{ route('link-list', [ 'id' => $list->id ]) }}">
